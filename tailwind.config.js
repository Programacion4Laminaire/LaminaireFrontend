...
module.exports = {
  content: ["./src/**/*.{html,ts}"],
  /* ⬇️  NUEVO: mantiene vivas las utilidades de grid-columns */
  safelist: [
    "grid",
    "grid-cols-1",
    "md:grid-cols-2",
  ...
  theme: {
    ...
    colors: {
      ...
      "am-main-custom4": {
        DEFAULT: "#ffffffff", // Verde principal
        light: "#92cab4ff", // Verde claro para background
        dark: "#0d943a", // Verde oscuro para hover o énfasis
      },
      "am-main-custom": {
        DEFAULT: "#ce938b",
        light: "#E9CEFF",
